...
Usage Examples:
  ...
  python orchestrator/app.py process --file registration_document.png --output outputs/registration.json
  python orchestrator/app.py process --file samples/sample.txt --output outputs/reply.wav
""")
